          ...
          <el-form :model="analysisSettings" label-width="120px">
            ...
            <el-form-item label="默认分析师">
              <el-checkbox-group v-model="analysisSettings.defaultAnalysts">
                <el-checkbox label="技术面分析师">技术面分析师</el-checkbox>
                ...
                <el-checkbox label="资金盘分析师">资金盘分析师</el-checkbox>
              </el-checkbox-group>
            </el-form-item>
...
const analysisSettings = ref({
  ...
  defaultAnalysts: authStore.user?.preferences?.default_analysts || ['技术面分析师', '基本面分析师', '市场分析师', '资金盘分析师'],
...
watch(() => authStore.user, (newUser) => {
  if (newUser) {
    ...
    analysisSettings.value.defaultAnalysts = newUser.preferences?.default_analysts || ['技术面分析师', '基本面分析师', '市场分析师', '资金盘分析师']
