...
def main():
    print("=" * 60)
    print("Analysis Test: 300033 + deepseek + market only")
    print("=" * 60)
    ...
    # Start analysis with specified parameters (per user's input)
    payload = {
        "symbol": STOCK_CODE,
    ...
    # Check prompts using the prompts endpoint
    ...
    if resp.status_code == 200:
        ...
        if prompts:
            ...
            print(f"  This means messages were not saved during analysis.")
            return 1
    else:
