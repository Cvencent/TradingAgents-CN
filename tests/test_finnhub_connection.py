...
def test_finnhub_api():
    ...
    if not finnhub_key:
        print("[X] 请设置 FINNHUB_API_KEY 环境变量")
        return False
    ...
    try:
        ...
        try:
            ...
            print(f"[X] Yahoo Finance API调用失败: {e}")
...
if __name__ == "__main__":
    ...
    print("\n" + "="*50)
    print("🎯 测试总结:")
    print(f"美股API测试: {'✅ 成功' if result1 else '[X] 失败'}")
    print(f"中国股票API测试: {'✅ 成功' if result2 else '[X] 失败'}")
