...
def test_tushare_provider():
    ...
    try:
        ...
        if provider.connected:
            ...
            print("[X] Tushare API连接失败")
        
    except Exception as e:
        print(f"[X] Tushare提供器测试失败: {e}")
        import traceback
        traceback.print_exc()
...
def check_tushare_environment():
    ...
    try:
        ...
        print("[X] Tushare库未安装，请运行: pip install tushare")
        return False
